    ...
    return OverlayEntry(
      builder: (BuildContext context) {
        return GestureDetector(
          onTap: () => <void>{closeMenu()},
          child: Container(height: MediaQuery.of(context).size.height, width: MediaQuery.of(context).size.width, color: widget.backdrop ? theme.colorScheme.onSurface.withAlpha(12) : Colors.transparent),
        );
      },
    );
  }
