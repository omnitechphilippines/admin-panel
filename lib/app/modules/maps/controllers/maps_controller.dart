...
class MapsController extends GetxController {
  ...
  void onInit() {
    ...
    dataSource = MapShapeSource.asset('assets/data/australia.json', shapeDataField: 'STATE_NAME', dataCount: data.length, primaryValueMapper: (int index) => data[index].state, dataLabelMapper: (int index) => data[index].dataLabel);
