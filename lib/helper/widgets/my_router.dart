...
import '../widgets/my_middleware.dart';
import '../widgets/my_route.dart';
import '../widgets/my_route_exception.dart';
import '../widgets/my_routes.dart';
...
class MyRouter {
  ...
  static Future<T?> pushReplacementNamed<T extends Object?, TO extends Object?>(BuildContext context, String routeName, {Object? arguments}) async {
    MyRoute? route = getSecuredRouteFromRouteName(routeName);
    if (route == null) {
      throw RouteException("'$routeName' Route is not implemented");
    }
