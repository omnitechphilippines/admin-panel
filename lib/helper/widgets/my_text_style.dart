...
enum MyTextType { displayLarge, displayMedium, displaySmall, headlineLarge, headlineMedium, headlineSmall, titleLarge, titleMedium, titleSmall, bodyLarge, bodyMedium, bodySmall, labelLarge, labelMedium, labelSmall }
...
class MyTextStyle {
  static GoogleFontFunction _fontFamily = GoogleFonts.publicSans;

  static void changeFontFamily(GoogleFontFunction value) {
    _fontFamily = value;
  }

  static Map<int, FontWeight> _defaultFontWeight = <int, FontWeight>{};

  static Map<MyTextType, double> _defaultTextSize = <MyTextType, double>{
  ...
  static Map<MyTextType, int> _defaultTextFontWeight = <MyTextType, int>{};

  static Map<MyTextType, double> _defaultLetterSpacing = <MyTextType, double>{};
  ...
  static TextStyle getStyle({
    ...
    return _fontFamily(fontSize: finalFontSize, fontWeight: _defaultFontWeight[fontWeight], letterSpacing: letterSpacing, color: finalColor, decoration: decoration, height: height, wordSpacing: wordSpacing);
  }
  ...
  static void resetFontStyles() {
    _fontFamily = GoogleFonts.publicSans;

    _defaultFontWeight = <int, FontWeight>{100: FontWeight.w100, 200: FontWeight.w200, 300: FontWeight.w300, 400: FontWeight.w300, 500: FontWeight.w400, 600: FontWeight.w500, 700: FontWeight.w600, 800: FontWeight.w700, 900: FontWeight.w800};

    _defaultTextSize = <MyTextType, double>{
      MyTextType.displayLarge: 57,
      MyTextType.displayMedium: 45,
      MyTextType.displaySmall: 36,
      MyTextType.headlineLarge: 32,
    ...
    _defaultTextFontWeight = <MyTextType, int>{
    ...
    _defaultLetterSpacing = <MyTextType, double>{
