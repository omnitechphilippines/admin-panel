      ...
      button = OutlinedButton(
        ...
        style:
            ...
            ButtonStyle(
              ...
              side: msSide ?? WidgetStateProperty.all(side ?? BorderSide(color: soft ? borderColor.withAlpha(100) : borderColor, width: soft ? 0.8 : 1)),
              ...
              shape: WidgetStateProperty.all(shape ?? RoundedRectangleBorder(borderRadius: BorderRadius.circular(borderRadiusAll ?? MyConstant.constant.buttonRadius))),
            ),
        child: child,
      );
