...
class MyCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final MyShadow myShadow = shadow ?? MyShadow();
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: <BoxShadow>[BoxShadow(color: myShadow.color ?? theme.shadowColor.withAlpha(myShadow.alpha), spreadRadius: myShadow.spreadRadius, blurRadius: myShadow.blurRadius, offset: myShadow.offset!)],
        ),
