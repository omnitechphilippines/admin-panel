...
class Utils {
  static DateTime convertStringToDate(String dateString) {
    try {
      return DateTime.parse(dateString); // Example: "2025-01-25"
    } catch (e) {
      return DateTime.now();
    }
  }
  ...
  static String getDateTimeStringFromDateTime(DateTime dateTime, {bool showSecond = true, bool showDate = true, bool showTime = true, bool showMonthShort = false}) {
